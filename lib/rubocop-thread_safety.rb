...
require 'rubocop/cop/thread_safety/env_mutation'
require 'rubocop/cop/thread_safety/rack_middleware_instance_variable'
require 'rubocop/cop/thread_safety/method_redefinition'
require 'rubocop/cop/thread_safety/lazy_synchronization_primitive'
